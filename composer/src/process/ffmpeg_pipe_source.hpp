...
enum class SourceKind {
    V4L2,  // -f v4l2 -input_format X -video_size WxH -framerate F -i device
    Lavfi, // -f lavfi -i "<device>"  (device IS the lavfi expression)
};
...
class FfmpegPipeSource {
  public:
    ...
    // Thread-safe snapshot of the most recent fully-written buffer.
