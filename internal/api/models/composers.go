...
type CanvasDimsData struct {
	...
	Background string `json:"background,omitempty" pattern:"^#?([0-9a-fA-F]{6}|[0-9a-fA-F]{8})$" example:"#1a1a2e" doc:"Canvas background color sources composite on top of, as #RRGGBB or #RRGGBBAA hex (empty = opaque black)"`
}
