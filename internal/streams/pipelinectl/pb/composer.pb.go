...
type SetCanvasRequest struct {
	...
	// Canvas background color the sources composite on top of. Hex
	// "#RRGGBB" or "#RRGGBBAA" (leading '#' optional). Empty = opaque black.
...
func (x *SetCanvasRequest) GetBackgroundColor() string {
	if x != nil {
