...
type SetCanvasParams struct {
	...
	H   uint32 `json:"h"`
	FPS uint32 `json:"fps"`
	// BackgroundColor is the canvas clear color sources composite on top
	// of, as "#RRGGBB" or "#RRGGBBAA" hex. Empty = opaque black.
...
type LayoutSlotEntry struct {
	...
	CropY           float32 `json:"crop_y,omitempty"`
	CropScale       float32 `json:"crop_scale,omitempty"`
}
