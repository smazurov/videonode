...
export function KonvaCanvasEditor({
  ...
  // Container sizing. A callback ref (re)attaches the ResizeObserver to whichever
  // element is currently measured, so the stage tracks the real post-ruler column
  // width instead of freezing on a node that React later swaps out.
  ...
  return (
    <div className="select-none min-w-0 overflow-hidden">
      ...
      <div className="flex items-start min-w-0">
        ...
        <div ref={setContainerEl} className="flex-1 min-w-0 ml-px">
          {stageW > 0 && (
          <Stage
            width={stageW}
            height={stageH}
