...
- **Build the application**: `go build -o videonode .`
- **Server is always running via air** on port 8090 with Basic Auth credentials: `pinball:pinball`
- **Health check**: `curl http://localhost:8090/api/health`


### V4L2 Detector (C component)
...
## Development Notes
- **Never update internal/server** - its deprecated, use it only to see how things used to work
