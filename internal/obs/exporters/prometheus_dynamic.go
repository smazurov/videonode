...
// PrometheusExporterV2 exports observability data in Prometheus format using dynamic collector
type PrometheusExporterV2 struct {
...
// NewPrometheusExporterV2 creates a new Prometheus exporter with dynamic metrics support
func NewPrometheusExporterV2() *PrometheusExporterV2 {
...
func (p *PrometheusExporterV2) Name() string {
	return p.config.Name
}

// Config returns the exporter configuration
func (p *PrometheusExporterV2) Config() obs.ExporterConfig {
	return p.config
}

// Start starts the Prometheus exporter
func (p *PrometheusExporterV2) Start(ctx context.Context) error {
	// Prometheus exporter doesn't need a background process
	return nil
}

// Stop stops the Prometheus exporter
func (p *PrometheusExporterV2) Stop() error {
	// Nothing to stop
	return nil
}

// Export processes and exports data points
func (p *PrometheusExporterV2) Export(points []obs.DataPoint) error {
	if len(points) == 0 {
		return nil
	}
...
func (p *PrometheusExporterV2) processBuffer() {
	if len(p.buffer) == 0 {
		return
	}
...
func (p *PrometheusExporterV2) determineMetricType(name string) prometheus.ValueType {
...
func (p *PrometheusExporterV2) sanitizeMetricName(name string) string {
...
func (p *PrometheusExporterV2) GetHandler() http.Handler {
...
func (p *PrometheusExporterV2) ForceFlush() {
	p.bufferMux.Lock()
	defer p.bufferMux.Unlock()
	p.processBuffer()
}
...
func (p *PrometheusExporterV2) Stats() map[string]interface{} {
	p.bufferMux.Lock()
