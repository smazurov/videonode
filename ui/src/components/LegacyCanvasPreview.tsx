...
// LegacyCanvasPreview is the pre-U9 renderer: it consumes the old solver
// output (CanvasLayoutData with slot_/content_ split rects). Kept temporarily
// to keep the legacy StreamForm building until U13/U14 delete it.
interface LegacyCanvasPreviewProps {
  canvasW: number;
  canvasH: number;
...
export function LegacyCanvasPreview({
  canvasW,
  canvasH,
  layout,
  loading = false,
  ...
  availableCount,
  hideCaption = false,
}: Readonly<LegacyCanvasPreviewProps>) {
