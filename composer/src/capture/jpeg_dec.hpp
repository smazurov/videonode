...
enum class Colorimetry { Unspecified, Bt601, Bt709 };
...
struct DecodedNv12 {
    ...
    uint32_t ver_stride = 0; // padded vertical stride; CSC needs it to find the UV plane
    ...
    Colorimetry colorimetry = Colorimetry::Unspecified;
};
